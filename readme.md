...
| :----------------------- | :------------------------------------ | :--------------------------------------------------------------------------------------------------- | :------------------------------------------ | :--------------------------------------- |
| **MCU**                  |Microcontroller Unit - Mikrokontrolerová jednotka                                       | Integrovaný čip (CPU + RAM + Flash na jednom substrátu), deterministický běh bez OS nebo RTOS        | např. ESP32, PIC16LF1xxx, RP2040            |Využívá se například v chytré domácnosti (IoT, ESP32) a umí automaticky řídit, sbírat data a komunikovat.                                          |
